...
This may take some time. You can speed it up by allocating more memory and CPUs. On our system, we allocated 16 CPUs, 32 GB of RAM, and 7 hours of compute for :code:`v1.1`. And for :code:`v2.0`, we allocated 64 CPUs, 640 GB of RAM, and ~3 days of compute.
