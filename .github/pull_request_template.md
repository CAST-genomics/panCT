...
- [ ] I've explained my changes in a manner that will make it possible for both users and maintainers of panct to understand them
* [ ] I have followed the [contributing guidelines](https://panct.readthedocs.io/en/stable/project_info/contributing.html#how-to-fix-a-bug-or-implement-a-new-feature)
* [ ] I have adhered to the [style guidelines](https://panct.readthedocs.io/en/stable/project_info/contributing.html#style)
...
* [ ] (if applicable) I've updated the pyproject.toml file with any changes I've made to panct's dependencies, and I've run `poetry lock --no-update` to ensure the lock file stays up to date and that our dependencies are locked to their minimum versions
